...
var (
	...
	projectImage = "example.com/operator-workload-placement-policy:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting operator-workload-placement-policy integration test suite\n")
